description = [
    ...
    {
        "description": "Query PubMed for papers based on the provided search query. Returns a list of dicts with keys: 'title', 'abstract', 'journal'. Use print_pubmed_results() to format the output nicely.",
        "name": "query_pubmed",
        "optional_parameters": [
            {
                "default": 10,
    ...
    {
        "description": "Format and display PubMed search results in a user-friendly way. Use this after query_pubmed() to show results in a nice format.",
        "name": "print_pubmed_results",
        "optional_parameters": [
            {
                "default": 5,
                "description": "Number of top papers to display.",
                "name": "top_n",
                "type": "int",
            },
            {
                "default": 300,
                "description": "Maximum length of abstract to show.",
        ...
        "required_parameters": [
            {
                "default": None,
                "description": "Name of the search category (e.g., '心衰治疗新进展').",
                "name": "category_name",
                "type": "str",
            },
            {
                "default": None,
                "description": "The list of paper dictionaries from query_pubmed().",
                "name": "papers",
                "type": "list",
            },
        ],
